...
KEYWORDS = {
    ...
    'appliance': ['瓦斯器具', '熱水器', '瓦斯爐', '爐具', '瓦斯配件', '瓦斯管線', '瓦斯開關', '瓦斯閥', '瓦斯表', '瓦斯偵測器']
}
...
如遇用戶詢問瓦斯桶容量（4、10、16、20、50公斤）或價格（200、420、550、660、1750元）時，請直接條列各容量對應的建議市價，並提醒價格會依地區與時期浮動。''',
